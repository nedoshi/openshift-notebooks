...
![UI Create Project](/images/4-createprojectname.png)
...
![UI Install Open Data Hub](/images/4-installedoperator.png)    
...
![UI Install Open Data Hub](/images/4-createinstance.png)  
...
![UI Project workload](/images/4-projectworkload.png) 

13. Click Routes under Networking and url to launch Jupyterhub is created
![UI Project workload routes](/images/4-projectworkload-routes.png)

14. Open JupyterHub on web browser
![UI JupyterHub](/images/4-jupyterhub.png)

15. Configure GPU and start server
![UI Start Server](/images/4-jupyterhub-gpu-size-startserver.png)

16. Check for GPU in notebook
![UI GPUCheck](/images/4-GPUcheck_notebook.png)